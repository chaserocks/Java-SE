...
public class KeyDriver {
		...
		public KDAFWLibrary lib;
		public int passCount=0;
		public int failCount=0;
		public int skipCount=0;
		
		public String controller="./TestDataScripts/Controller.xlsx";
		public String scenarios="./TestDataScripts/Scenarios.xlsx";
		...
		{	
		  ...
		  for(int i=1;i<=scenarioCount;i++)
		  {
			  ...
			  if(executeScenario.equalsIgnoreCase("yes"))
			  {
				  ...
				  logger.info("!!!! Execution Status of above scenario:"+ KDAFWLibrary.scriptStatus+" !!!!");
				  logger.info("======================================================");
			  }
			  else
			  {
			...
			logger.info("StepCount:"+StepCount);
				for(int k=1;k<=StepCount;k++)
				{
					...
					else
					{
						...
						KDAFWLibrary.scriptStatus="FAIL";
					}
				}
