...
// finally : finally : It is a used along with try catch block mostly or can be used along with try alone (try-finally). 
// This block gets executed irrespective of a statement generating an exception or not we can have try-catch finally or try-finally 
